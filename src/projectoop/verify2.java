...
public class verify2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        knownButton.setText("känd");
        knownButton.setName("knownButton");
        ...
        idButton.setText("ID / Pass");
        idButton.setName("idButton");
        ...
        jLabel2.setText("Vänligen identifiera dig");

        jButton2.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        jButton2.setForeground(new java.awt.Color(204, 0, 204));
        jButton2.setText("Tillbaks Till Huvudsidan");
